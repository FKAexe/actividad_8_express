...
const selectPosts = async () => {
    const [result] = await db.query('SELECT a.nombre AS autor a.id as autorid, p.id, p.titulo, p.descripcion, p.fecha_creacion p.categoria FROM posts p JOIN autores a ON p.autor_id = a.id');
    return result;
}
...
module.exports = { selectPosts, insertPost };